...
\import { dateFormat, requestAnimationFrame, cancelAnimationFrame, rafTimeout, cancelRaf, throttle, debounce, add, downloadFile, moneyFormat } from 'Bizarre-ui'
<\/script>`,
  },
])
...
const countdown = computed(() => {
  return getOffDate('9:05')
})
</script>
<template>
  <div>
    <Countdown class="countdown" title="Off Duty" :value="countdown" format="HH:mm:ss" finished-text="GO GO GO" @finish="onFinish" />
    <h1>Bizarre UI</h1>
    ...
    <ul class="m-list">
      ...
      <li class="u-tip mb10">
        git clone
        <a href="https://github.com/FyStrive/bizarre-ui.git" target="_blank">Bizarre-ui</a>
        到本地后，从 packages 下单独拷贝单文件组件 (SFC) 到项目内使用
      </li>
    </ul>
